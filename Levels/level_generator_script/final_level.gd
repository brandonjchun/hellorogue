...
@onready var enemy_spawn_1 = $enemy_spawn1
@onready var enemy_spawn_2 = $enemy_spawn2
@onready var enemy_spawn_3 = $enemy_spawn3
@onready var enemy_spawn_4 = $enemy_spawn4
@onready var enemy_spawn_5 = $enemy_spawn5
@onready var enemy_spawn_6 = $enemy_spawn6
@onready var enemy_spawn_7 = $enemy_spawn7
@onready var enemy_spawn_8 = $enemy_spawn8
@onready var enemy_spawn_9 = $enemy_spawn9
@onready var enemy_spawn_10 = $enemy_spawn10
...
func _on_spikes_timer_timeout():
	if spikes_array.size()-5 >= 1:
		var spike_type = randi_range(0, 1)
		var spike_position_source = randi_range(0, spikes_array.size()-5)
